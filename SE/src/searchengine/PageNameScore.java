...
public class PageNameScore implements Comparable<PageNameScore> {
	...
	public PageNameScore(final String name, final int score) {
	...
	public int compareTo(PageNameScore to) 
	{
