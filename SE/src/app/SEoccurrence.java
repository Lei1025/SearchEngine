...
import searchengine.PageNameScore;
import searchengine.RankingResult;
import util.SentenceFragment;
...
public class SEoccurrence  {
	...
	private void getSearchResult(String searchText) {
		...
		List<PageNameScore> searchResult = RankingResult.listTop10Pages(words);
		for (PageNameScore page : searchResult) {
			...
			try {
				...
				System.out.println("Showing fragment sentences : "+SentenceFragment.pickFragment(page.getPageName(), words));
